        ...
        <div>
            ...
            <div className="flex flex-col items-center justify-center h-screen bg-white " >
                <div className="m-2 mb-3 self-center">
                    ...
                    <h1 className=" text-black text-3xl font-semibold text-center">This nuclide does not exist.</h1>
                    <h1 className=" text-black text-3xl font-semibold text-center">Would you like to search again?</h1>
